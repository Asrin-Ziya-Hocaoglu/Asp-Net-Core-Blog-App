...
namespace ProgrammersBlog.Services.Abstract
{
    public interface ICategoryService
    {
        ...
        /// <summary>
        /// Verilen CategoryAddDto ve CreatedByName ait parametrelere göre yeni bir Category ekler.
        /// </summary>
        ...
        /// <returns>Asenkron bir operasyon ile Task olarak bizlere ekleme işleminin sonucunu DataResult tipinde geriye döner.</returns>
